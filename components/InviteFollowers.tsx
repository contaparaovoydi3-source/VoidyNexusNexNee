            ...
            return (
              ...
              >
                <div className="w-14 h-14 rounded-2xl overflow-hidden border border-white/10 shrink-0 bg-slate-900 shadow-xl">
                   <img src={resolveImageRef(member.avatarUrl) || `https://api.dicebear.com/7.x/avataaars/svg?seed=${member.name}`} className="w-full h-full object-cover" alt={member.name} />
                </div>
