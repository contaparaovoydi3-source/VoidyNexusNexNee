  ...
  return (
    <div className={`${isMobileFull ? 'w-full h-full' : 'w-80 h-full border-r border-slate-800/50'} glass flex flex-col p-6 z-10 relative rounded-3xl overflow-hidden`}>
      ...
      <div className="mb-10 text-center">
        <h1 className="text-2xl font-syncopate font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 mb-1 uppercase">
          {character.name || 'OPERATIVO'}
        </h1>
