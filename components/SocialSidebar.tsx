...
const SocialSidebar: React.FC<SocialSidebarProps> = ({ 
  ...
  onNavigateToPrivate, onNavigateToMembers, onNavigateToChats, onNavigateToPublicChat, onNavigateToRanking, onNavigateToDrafts, onCreateCluster, 
  ...
  const menuItems = [
    ...
    { id: 'membros', icon: 'Membros', label: 'Membros', action: onNavigateToMembers },
